...
public class OrderItemMapper extends Mapper<OrderItemDTO, String> {
    ...
    @Override
    protected PreparedStatement getInsertStatement(OrderItemDTO orderItemDTO, Connection connection) throws SQLException {
    ...
    @Override
    protected PreparedStatement getUpdateStatement(OrderItemDTO obj, Connection connection) throws SQLException {
        return null;
    }

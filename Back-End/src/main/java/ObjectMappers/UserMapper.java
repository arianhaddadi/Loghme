...
public class UserMapper extends Mapper<UserDTO, String> {
    ...
    @Override
    protected PreparedStatement getInsertStatement(UserDTO userDTO, Connection connection)
            throws SQLException {
        PreparedStatement preparedStatement =
                connection.prepareStatement("INSERT IGNORE INTO Users VALUES (?, ?, ?, ?, ?, ?);");
    ...
    @Override
    protected PreparedStatement getUpdateStatement(UserDTO userDTO, Connection connection)
            throws SQLException {
        PreparedStatement preparedStatement =
                connection.prepareStatement("UPDATE Users SET credit = ? WHERE email = ?;");

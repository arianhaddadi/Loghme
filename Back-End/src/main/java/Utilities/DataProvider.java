...
public class DataProvider {
    ...
    public static ArrayList<Restaurant> getRestaurants() {
        ...
        Restaurant r1 = new Restaurant("r1", "rest1", "logo1", new Location(1.0F, 1.0F), foodItems, foodPartyItems);
        Restaurant r2 = new Restaurant("r2", "rest2", "logo2", new Location(2.0F, 2.0F), foodItems, foodPartyItems);
        Restaurant r3 = new Restaurant("r3", "rest3", "logo3", new Location(3.0F, 3.0F), foodItems, foodPartyItems);
        Restaurant r4 = new Restaurant("r4", "rest4", "logo4", new Location(4.0F, 4.0F), foodItems, foodPartyItems);

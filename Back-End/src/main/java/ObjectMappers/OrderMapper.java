...
public class OrderMapper extends Mapper<OrderDTO, String> {
    ...
    @Override
    protected PreparedStatement getInsertStatement(OrderDTO orderDTO, Connection connection)
            throws SQLException {
        PreparedStatement preparedStatement =
                connection.prepareStatement("INSERT IGNORE INTO Orders VALUES (?, ?, ?);");
    ...
    @Override
    protected PreparedStatement getUpdateStatement(OrderDTO orderDTO, Connection connection)
            throws SQLException {
        PreparedStatement preparedStatement =
